...
const cognitoAuthConfig = {
  ...
  redirect_uri: import.meta.env.VITE_COGNITO_REDIRECT_URI || "http://localhost:5173",   // Must match EXACTLY what's in Cognito Console → App Client → Allowed Callback URLs
  response_type: "code",
